...
| --- | --- | --- |
| OrcaSlicer | <https://github.com/OrcaSlicer/OrcaSlicer> | Primary upstream slicer/app lineage. Preserve AGPL, notices, and upstream attribution. |
| Bambu Studio | <https://github.com/bambulab/BambuStudio> | Upstream family member and connectivity/plugin behavior reference. Treat proprietary or closed plugin behavior with caution. |
| PrusaSlicer | <https://github.com/prusa3d/PrusaSlicer> | Upstream slicer family lineage and PrusaLink/profile behavior reference. Preserve AGPL attribution. |
| Slic3r | <https://github.com/slic3r/Slic3r> | Original lineage behind PrusaSlicer-derived slicers. Credit in family-tree explanations. |
