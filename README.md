...
| Lane | Status | Notes |
| --- | --- | --- |
| Native FibreSeek planner | Experimental / active | Standalone continuous-fiber G-code generation path with light/medium/heavy reinforcement modes, layer guard controls, 90 mm mechanical route filtering, printable-path guards, and rendered fiber preview support. |
