...
- `tinmanx1-v2.4.0-houseclean-native-fiber.patch`: current TinManX1 source patch on the Orca Slicer 2.4.0 source line. It includes rebrand cleanup, startup splash correction, native FibreSeek planning, fiber preview/summary support, fiber infill density/angle controls, fiber-only seam controls, profile/process wiring checks, Rocket/TinManX1 comparison tooling, Wave Overhangs, Arc Support, Strength Lens, helper resources, attribution, and smoke checks.
