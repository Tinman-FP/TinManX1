...
Slic3r::ExtrusionRole convert(EGCodeExtrusionRole role)
{
    ...
    case EGCodeExtrusionRole::ContinuousFiber:          { return Slic3r::ExtrusionRole::erContinuousFiber; }
...
EGCodeExtrusionRole convert(Slic3r::ExtrusionRole role)
{
    ...
    case Slic3r::ExtrusionRole::erContinuousFiber:             { return EGCodeExtrusionRole::ContinuousFiber; }
